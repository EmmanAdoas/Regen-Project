...
qqnorm(regen_data1N$lai_4_ring)
qqline(regen_data1N$lai_4_ring, col= "red")
shapiro.test(regen_data1N$lai_4_ring)
LAI_4rings_krustal <- kruskal.test(lai_4_ring ~ gap_type, data = regen_data1N)
View(LAI_4rings_krustal)
...
qqnorm(regen_data1N$lai_5_ring)
qqline(regen_data1N$lai_4_ring, col= "red")
shapiro.test(regen_data1N$lai_5_ring)
LAI_5rings_krustal <- kruskal.test(lai_5_ring ~ gap_type, data = regen_data1N)
View(LAI_5rings_krustal)
...
qqnorm(tph_vrs_regen$tph)
qqline(tph_vrs_regen$tph, col= "red")
shapiro.test(tph_vrs_regen$tph)
TPH_krustal <- kruskal.test(tph ~ gap_type, data = tph_vrs_regen)
View(TPH_krustal)
...
qqnorm(regen_data1N$trans_tot)
qqline(regen_data1N$trans_tot, col= "red")
shapiro.test(regen_data1N$trans_tot)
Totalradiation_krustal <- kruskal.test(trans_tot ~ gap_type, data = regen_data1N)
View(Totalradiation_krustal)
```
...
qqnorm(regen_data1N$x_site_open)
qqline(regen_data1N$x_site_open, col= "red")
shapiro.test(regen_data1N$x_site_open)
Openness_krustal <- kruskal.test(x_site_open ~ gap_type, data = regen_data1N)
View(Openness_krustal)
```
...
qqnorm(regen_data1N$x_trans_tot)
qqline(regen_data1N$x_trans_tot, col= "red")
shapiro.test(regen_data1N$x_trans_tot)
Totaltrans_krustal <- kruskal.test(x_trans_tot ~ gap_type, data = regen_data1N)
View(Totaltrans_krustal)
```
...
qqnorm(GrowthVariables$meanH)
qqline(GrowthVariables$meanH, col= "red")
shapiro.test(GrowthVariables$meanH)
Height_krustal <- kruskal.test(meanH ~ gap_type, data = GrowthVariables)
View(Height_krustal)
```
...
qqnorm(GrowthVariables$meanG)
qqline(GrowthVariables$meanG, col= "red")
shapiro.test(GrowthVariables$meanG)
Growth_krustal <- kruskal.test(meanG ~ gap_type, data = GrowthVariables)
View(Growth_krustal)
```
...
qqnorm(GrowthVariables$meanD)
qqline(GrowthVariables$meanD, col= "red")
shapiro.test(GrowthVariables$meanD)
Diameter_krustal <- kruskal.test(meanD ~ gap_type, data = GrowthVariables)
View(Diameter_krustal)
```
...
qqnorm(GrowthVariables$meanW)
qqline(GrowthVariables$meanW, col= "red")
shapiro.test(GrowthVariables$meanW)
Width_krustal <- kruskal.test(meanW ~ gap_type, data = GrowthVariables)
View(Width_krustal)
```
...
qqnorm(site_values$SST)
qqline(site_values$SST, col= "red")
shapiro.test(site_values$SST)
Ss_krustal <- kruskal.test(SST ~ gap_type, data = site_values)
View(Ss_krustal)
...
qqnorm(site_values$SIT)
qqline(site_values$SIT, col= "red")
shapiro.test(site_values$SIT)
Si_krustal <- kruskal.test(SIT ~ gap_type, data = site_values)
View(Si_krustal)
```
...
lines(Demdata_vrs_regenS$aspect_dem11T,c(predict(n), NA),col="red",lty=2,lwd=3)
# For convenience put the residuals in the variable res
...
lines(Demdata_vrs_regenS$aslope_dem_1m1,predict(p),col="red",lty=2,lwd=3)
# For convenience put the residuals in the variable res
...
summary(u)
#get some estimation of goodness of fit
cor(Demdata_vrs_regenN$tph,predict(u))
#plot the fit
plot(Demdata_vrs_regenN$dem1, Demdata_vrs_regenN$tph )
lines(Demdata_vrs_regenN$dem1,predict(u),col="red",lty=2,lwd=3)
# For convenience put the residuals in the variable res
res <- predict(u)-Demdata_vrs_regenN$tph
# Calculate RMSE, assign it to the variable rmse and print it
(rmse <- sqrt(mean(res^2)))
```
...
lines(Demdata_vrs_regenS$SST,c(predict(v), NA),col="red",lty=2,lwd=3)
# For convenience put the residuals in the variable res
...
lines(Demdata_vrs_regenN$SST,predict(w),col="red",lty=2,lwd=3)
# For convenience put the residuals in the variable res
...
summary(d)
#get some estimation of goodness of fit
cor(Regen_by_coverS$tph,c(predict(d), NA), use='complete.obs')
#plot the fit
plot(Regen_by_coverS$sl, Regen_by_coverS$tph )
lines(Regen_by_coverS$sl,c(predict(d), NA),col="red",lty=2,lwd=3)
# For convenience put the residuals in the variable res
