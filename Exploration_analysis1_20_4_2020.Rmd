...
TWI_anova <- aov(twi_1mfina ~ gap_type, data = NMDS_data)
summary(TWI_anova)
...
Dist_anova <- aov(twi_1mfina ~ gap_type, data = NMDS_data)
summary(Dist_anova)
...
Slope_anova <- aov(slope_dem_1m1 ~ gap_type, data = NMDS_data)
summary(Slope_anova)
...
Ele_anova <- aov(twi_1mfina ~ gap_type, data = NMDS_data)
summary(Ele_anova)
...
As_anova <- aov(aspect_dem11 ~ gap_type, data = NMDS_data)
summary(As_anova)
...
Gap_anova <- aov(Gap_area ~ gap_type, data = NMDS_data)
summary(Gap_anova)
```
