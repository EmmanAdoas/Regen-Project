...
Salavge
```{r }
ggplot(H_LAI_S, aes(meanH, lai_4_ring)) +
geom_point() +
theme_classic()

ggplot(H_LAI_S, aes(meanH, lai_5_ring)) +
geom_point() +
theme_classic()
```
...
Natural
```{r }
ggplot(H_LAI_N, aes(meanH, lai_4_ring)) +
geom_point() +
theme_classic()

ggplot(H_LAI_N, aes(meanH, lai_5_ring)) +
geom_point() +
theme_classic()
```
...
Salvage
```{r}
ggplot(G_LAI_S, aes(meanG, lai_4_ring)) +
geom_point() +
theme_classic()

ggplot(G_LAI_S, aes(meanG, lai_5_ring)) +
geom_point() +
theme_classic()
```
...
Natural
```{r }
ggplot(G_LAI_N, aes(meanG, lai_4_ring)) +
geom_point() +
theme_classic()

ggplot(G_LAI_N, aes(meanG, lai_5_ring)) +
geom_point() +
theme_classic()
```
...
Slavage
```{r }
ggplot(D_LAI_S, aes(meanD, lai_4_ring)) +
geom_point() +
theme_classic()

ggplot(D_LAI_S, aes(meanD, lai_5_ring)) +
geom_point() +
theme_classic()
```
...
Natural
```{r }
ggplot(D_LAI_N, aes(meanD, lai_4_ring)) +
geom_point() +
theme_classic()

ggplot(D_LAI_N, aes(meanD, lai_5_ring)) +
geom_point() +
theme_classic()
```
...
Salavage
```{r }
ggplot(W_LAI_S, aes(meanW, lai_4_ring)) +
geom_point() +
theme_classic()

ggplot(W_LAI_S, aes(meanW, lai_5_ring)) +
geom_point() +
theme_classic()
```
...
Natural
```{r }
ggplot(W_LAI_N, aes(meanW, lai_4_ring)) +
geom_point() +
theme_classic()

ggplot(W_LAI_N, aes(meanW, lai_5_ring)) +
geom_point() +
theme_classic()
```
...
Salvage
```{r}
ggplot(Regen_by_Aslo_S, aes(tph, slope)) +
geom_point() +
theme_classic()

ggplot(Regen_by_Aslo_S, aes(tph, aspect)) +
geom_point() +
theme_classic()
```
...
Natural 
```{r}
ggplot(Regen_by_Aslo_N, aes(tph, slope)) +
geom_point() +
theme_classic()

ggplot(Regen_by_Aslo_N, aes(tph, aspect)) +
geom_point() +
theme_classic()
```
...
Salvage
```{r }
ggplot(Height_vrs_Aslo_S, aes(meanH, slope)) +
geom_point()+
theme_classic()

ggplot(Height_vrs_Aslo_S, aes(meanH, aspect)) +
geom_point()+
theme_classic()
...
Natural
```{r }
ggplot(Height_vrs_Aslo_N, aes(meanH, slope)) +
geom_point()+
theme_classic()

ggplot(Height_vrs_Aslo_N, aes(meanH, aspect)) +
geom_point()+
theme_classic()
...
```{r}
ggplot(Regen_by_coverS, aes(tph, ms)) +
geom_point()+
theme_classic()

ggplot(Regen_by_coverN, aes(tph, ms)) +
geom_point()+
theme_classic()
```
...
```{r}
ggplot(Regen_by_coverS, aes(tph, ts)) +
geom_point()+
theme_classic()

ggplot(Regen_by_coverN, aes(tph, ts)) +
geom_point()+
theme_classic()
```
...
```{r}
ggplot(Regen_by_coverS, aes(tph, wd)) +
geom_point()+
theme_classic()

ggplot(Regen_by_coverN, aes(tph, wd)) +
geom_point()+
theme_classic()
```
...
For Grass
```{r}
ggplot(Regen_by_coverS, aes(tph, gs)) +
geom_point()+
theme_classic()

ggplot(Regen_by_coverN, aes(tph, gs)) +
geom_point()+
theme_classic()
```
...
For Shrub
```{r}
ggplot(Regen_by_coverS, aes(tph, sb)) +
geom_point()+
theme_classic()

ggplot(Regen_by_coverN, aes(tph, sb)) +
geom_point()+
theme_classic()
```
...
For Forbs
```{r}
ggplot(Regen_by_coverS, aes(tph, fb)) +
geom_point()+
theme_classic()

ggplot(Regen_by_coverN, aes(tph, fb)) +
geom_point()+
theme_classic()
```
...
For soil
```{r}
ggplot(Regen_by_coverS, aes(tph, sl)) +
geom_point()+
theme_classic()

ggplot(Regen_by_coverN, aes(tph, sl)) +
geom_point()+
theme_classic()
```
...
For rock 
```{r}
ggplot(Regen_by_coverS, aes(tph, rk)) +
geom_point()+
theme_classic()

ggplot(Regen_by_coverN, aes(tph, rk)) +
geom_point()+
theme_classic()
```
...
For Duff 
```{r}
ggplot(Regen_by_coverS, aes(tph, df)) +
geom_point()+
theme_classic()

ggplot(Regen_by_coverN, aes(tph, df)) +
geom_point()+
theme_classic()
```
